document.addEventListener('DOMContentLoaded', () => {
    ...
    const b2cFreeSteps = [
        ...
        { id: 'upgrade_info', attachTo: { element: '#subscribe-container', on: 'bottom' }, title: 'Mehr Funktionen', text: 'Um Fristen zu verwalten, Dokumente zu unterschreiben oder den Antragshelfer zu nutzen, können Sie hier jederzeit auf Premium oder Premium Plus upgraden.' },
